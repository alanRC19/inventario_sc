...
export const ArticuloDetailModal: React.FC<ArticuloDetailProps> = ({
  ...
  const stockStatus = articulo.stock <= 0 ? 'error' :
                     articulo.stock <= articulo.stockMinimo ? 'warning' :
                     articulo.stock <= articulo.puntoReorden ? 'info' : 'success';
