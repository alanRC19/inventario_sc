    ...
    <main className="p-8 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl shadow border border-[#ececec] p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-black mt-2">{loading ? "..." : articulos.length}</p>
            </div>
            <span className="material-icons text-2xl text-black bg-transparent">inventory_2</span>
          </div>
          <div className="mt-4">
            <p className="text-sm text-gray-500">Total de productos registrados en el sistema</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow border border-[#ececec] p-6 hover:shadow-lg transition-shadow">
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-500">Suma total del valor de todos los productos en inventario</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow border border-[#ececec] p-6 hover:shadow-lg transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">{loading ? "..." : `${totalVentas} ventas registradas`}</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-8">
        ...
        <a
          href="/inventario"
          className="bg-white rounded-xl shadow p-8 flex flex-col items-center hover:shadow-lg transition group border border-[#ececec]"
        >
          <span
            className="material-icons w-10 h-10 mb-4 text-black group-hover:text-[#b91c1c]"
            style={{ fontSize: 40 }}
          >
            inventory_2
          </span>
        ...
        >
          <svg
            className="w-10 h-10 mb-4 text-black group-hover:text-[#b91c1c]"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
            viewBox="0 0 24 24"
